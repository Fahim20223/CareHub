            ...
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      {...register("phone", {
                        ...
                        pattern: {
                          value: /^(\+?88)?01[3-9]\d{8}$/,
                          message: "Invalid phone number (e.g., 01700000000)",
                        },
                      })}
                      className={`w-full pl-12 pr-4 py-3 rounded-xl border-2 ${
                        errors.phone
                ...
                >
                  ...
                  {/* <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    6+ chars, 1 uppercase, 1 lowercase, 1 number, 1 special char
                    (@$!%*?&)
                  </p> */}
                </motion.div>
              ...
              <div className="flex items-start gap-2">
                <input
                  ...
                  className="checkbox checkbox-sm border-gray-300 dark:border-gray-600 text-pink-500 dark:text-green-500 mt-1"
                />
                <div>
